...
class Recv3DescViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.btnExec.tag = 1
        self.btnExec.addTarget(self, action: #selector(Recv3DescViewController.onClickButton(_:)), for: .touchUpInside)
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(Recv3DescViewController.onOrientationChange(_:)), name: NSNotification.Name.UIDeviceOrientationDidChange, object: nil)
    }
