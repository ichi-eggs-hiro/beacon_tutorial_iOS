...
class Recv3DescViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.lblDesc1.text = "ビーコン領域内のビーコンを受信すると、GPSから取得した緯度経度で地図に表示します。"
        ...
        self.btnExec.tag = 1
        self.btnExec.addTarget(self, action: #selector(Recv3DescViewController.onClickButton(_:)), forControlEvents: .TouchUpInside)
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(Recv3DescViewController.onOrientationChange(_:)), name: UIDeviceOrientationDidChangeNotification, object: nil)
    }
