...
class Recv1DescViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.lblDesc1.text = "ビーコン領域の観測を行います。ビーコン領域の出入りがアラートとして通知されます。"
        ...
        let btnX :CGFloat = (self.view.frame.width - self.imgExec.size.width) / 2
        ...
        self.btnExec.tag = 1
        self.btnExec.addTarget(self, action: #selector(Recv1DescViewController.onClickButton(_:)), forControlEvents: .TouchUpInside)
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(Recv1DescViewController.onOrientationChange(_:)), name: UIDeviceOrientationDidChangeNotification, object: nil)
    }
